...
export const ConversationDeleteDialog = (props: IConversationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adjustApp.conversation.delete.question">
        <Translate contentKey="adjustApp.conversation.delete.question" interpolate={{ id: conversationEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-conversation" color="danger" onClick={confirmDelete}>
